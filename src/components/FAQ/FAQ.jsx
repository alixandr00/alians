...
export const FAQ = () => {
    ...
    // Если t('faq.questions') не массив, подстрахуемся пустым массивом
    ...
    return (
        <div className={`faq-container ${isRTL ? 'rtl' : ''}`} dir={isRTL ? 'rtl' : 'ltr'}>
                    ...
                    <div key={index} className={`faq-item ${openIndex === index ? 'active' : ''}`}>
                        ...
                        <div className="faq-answer">
                            <div className="answer-content">
                                {/* Здесь логика вывода ответа, например questions[index].answer */}
            ...
            {/* НОВАЯ Плавающая кнопка (фиксированная) */}
            <a href="https://wa.me/yournumber" className="floating-whatsapp" target="_blank" rel="noopener noreferrer">
